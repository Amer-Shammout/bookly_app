...
import 'package:bookly_app/Feautures/Home/presentation/views/widgets/book_details_view_body.dart';
...
class _BookDetailsViewState extends State<BookDetailsView> {
  ...
  void initState() {
    BlocProvider.of<SimilarBooksCubit>(context).fetchSimilarBooks(
        category:
            widget.bookModel.volumeInfo.categories?.first ?? 'Programming');
